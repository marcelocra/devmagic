...
type TabType = 'standalone' | 'consumer' | 'maintainer'
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          DevMagic can be used in three different ways. Choose the one that fits your workflow.
        </p>

        {/* Prerequisites */}
        <section className="mb-12 bg-muted/50 rounded-lg p-6">
          <h2 className="text-2xl font-bold mb-4">Prerequisites (All Modes)</h2>
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <div>
                <strong>Container Runtime:</strong> Install <a href="https://podman-desktop.io" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Podman Desktop</a> or Docker
              </div>
            </li>
            <li className="flex items-start gap-3">
              <svg className="w-6 h-6 text-primary mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <strong>Editor:</strong> Install <a href="https://code.visualstudio.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Visual Studio Code</a> (or any Dev Container compatible editor)
              </div>
            </li>
          </ul>
        </section>
        ...
        <div className="mb-8">
          ...
          {activeTab === 'standalone' && (
            <div className="bg-card border border-border rounded-lg p-8">
              <div className="mb-6">
                <h2 className="text-3xl font-bold mb-3">Standalone Mode</h2>
...
cd devmagic`}
                ...
                <div>
                  ...
                  <p className="mb-2">
                    Open the folder in VS Code and choose <strong>&quot;Reopen in Container&quot;</strong> when prompted.
                  </p>
...
code .`}
                  />
                  <p className="mt-2 text-sm text-muted-foreground">
                    Each cloned repo automatically uses the same dev container setup, making DevMagic a portable coding box you can carry between machines.
                  </p>
                </div>
                ...
                <div className="bg-muted/50 rounded-lg p-4 mt-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Each image might have a different default user. Check the <code>remoteUser</code> setting in <code>.devcontainer/devcontainer.json</code> and adjust any paths that depend on the user (like volume mounts).
                  </p>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'maintainer' && (
            <div className="bg-card border border-border rounded-lg p-8">
              <div className="mb-6">
                ...
                <p className="text-lg text-muted-foreground">
                  Develop DevMagic itself (including this website in the <code>www/</code> folder) using its own Dev Container. Self-hosting at its finest!
                </p>
              </div>
...
cd devmagic`}
                ...
                <div>
                  ...
                  <p className="mb-2">
                    A wrapper <code>.devcontainer/devcontainer.json</code> file is included at the root level. VS Code will detect it and allow you to <strong>&quot;Reopen in Container&quot;</strong>.
                  </p>
                </div>
        ...
        <section className="mt-12 bg-primary/5 rounded-lg p-6">
          ...
          <ul className="space-y-3">
            <li>
              ...
              <p className="text-sm text-muted-foreground">Learn about auxiliary services, customization, and how it all works</p>
            </li>
            <li>
            ...
            <li>
              <a href="https://github.com/marcelocra/devmagic/issues" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">
                Get help or contribute →
              </a>
              <p className="text-sm text-muted-foreground">Join the community, report issues, or contribute improvements</p>
            </li>
          </ul>
        </section>
      </div>
